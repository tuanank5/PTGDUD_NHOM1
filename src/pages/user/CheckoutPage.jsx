...
export default function CheckoutPage() {
  ...
  const [formData, setFormData] = useState({
    fullName: "", phone: "", province: "", district: "", ward: "", addressDetail: "", note: ""
  });
...
const handleFinalCheckout = () => {
  if (!formData.fullName.trim() || !formData.phone.trim() || !formData.province || !formData.ward) {
  ...
  const newOrder = {
    ...
    tracking: [{ time: new Date().toLocaleString(), desc: "Đơn hàng đã được đặt thành công" }]
  };
            ...
            <div className="card-box">
              ...
              <div className="input-row-flex">
                ...
                <div className="input-item">
                  ...
                  <input type="tel" placeholder="Ví dụ: 0123456789" 
              ...
              <div className="address-select-grid">
                ...
                <div className="input-item">
                  ...
                  <select onChange={(e) => setFormData({...formData, ward: e.target.value})}>
              ...
              <div className="input-item full-width" style={{marginBottom: '20px'}}>
              ...
              <div className="input-item full-width">
                ...
                <textarea rows="3" placeholder="Ghi chú yêu cầu đặc biệt cho đơn hàng của bạn..."
                  onChange={(e) => setFormData({...formData, note: e.target.value})}></textarea>
              </div>

              <h2 className="section-title" style={{marginTop: '40px'}}>2. VẬN CHUYỂN & THANH TOÁN</h2>
              <div className="method-selection-container">
                <div className="method-column">
                  <h4 className="all-labels">Vận chuyển (*)</h4>
                  <div className={`selection-card ${shippingMethod === "saving" ? "active" : ""}`} 
                       onClick={() => {setShippingMethod("saving"); setShippingFee(30000);}}>
                    <input type="radio" checked={shippingMethod === "saving"} readOnly />
                  ...
                  {formData.province === "Thành phố Hồ Chí Minh" && (
                    <div className={`selection-card ${shippingMethod === "express" ? "active" : ""}`}
                         onClick={() => {setShippingMethod("express"); setShippingFee(100000);}}>
                ...
                <div className="method-column">
                  ...
                  <div className={`selection-card ${paymentMethod === "cod" ? "active" : ""}`}
                  ...
                  <div className={`selection-card ${paymentMethod === "bank" ? "active" : ""}`}
              ...
              {paymentMethod === "bank" && (
                <div className="bank-transfer-info">
                  ...
                  <div className="bank-card">
                    ...
                    <p>Số tài khoản: <strong>0123 4567 8999</strong></p>
                    <p>Chủ tài khoản: <strong>NGUYEN VAN A</strong></p>
                    <p>Nội dung: <strong>{formData.phone || "Thanh toan don hang"}</strong></p>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="order-box">
              ...
              <div className="item-preview-container">
                {cart.map((item) => (
                  <div className="item-row-preview" key={item.id}>
                    ...
                    <span className="price-tag">{(item.price * item.quantity).toLocaleString()}đ</span>
                  </div>
                ))}
              </div>

              <div className="promo-section">
                <input type="text" placeholder="Mã giảm giá" value={promoCode} onChange={(e) => setPromoCode(e.target.value)} />
              ...
              <div className="final-price-calc">
                ...
                <div className="total-row">
                  ...
                  <span className="total-val">{(totalPrice + shippingFee - discount).toLocaleString()}đ</span>
                </div>
              </div>
              <button className="final-checkout-btn" onClick={handleFinalCheckout}>THANH TOÁN</button>
            </div>
          </div>
        </div>
      </div>
      ...
      {showSuccessModal && (
        <div className="modal-overlay">
          <div className="success-modal">
            ...
            <p className="modal-desc">Đơn hàng của bạn đã được xác nhận thành công.</p>
            <div className="modal-actions">
              <button className="btn-outline" onClick={() => window.location.href = "/orders"}>
                ĐƠN HÀNG CỦA BẠN
              </button>
