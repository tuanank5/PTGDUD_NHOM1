  ...
  const ProductSlider = ({ list }) => {
    ...
    return (
      <div className="product-slider-wrapper">
        <button className="slide-btn left" onClick={() => sliderRef.current.scrollLeft -= 300}>‹</button>
        ...
        <button className="slide-btn right" onClick={() => sliderRef.current.scrollLeft += 300}>›</button>
      </div>
    );
  };
